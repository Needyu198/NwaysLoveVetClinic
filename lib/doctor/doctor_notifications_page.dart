                ...
                final generated = <(String, String)>[
                  if (AppointmentStore.instance.appointments.any(
                    ...
                    (
                      ...
                      'A booking is waiting for review.',
                    ),
                  if (AppointmentStore.instance.appointments.any(
                    ...
                    (
                      ...
                      'A pet owner cancelled a booking.',
                    ),
                  if (AppointmentStore.instance.appointments.any(
                    (appointment) =>
                  ...
                  if (EmergencyRequestStore.instance.requests.any(
                    ...
                    (
                      ...
                      'Review and prioritize the emergency.',
                    ),
                  if (HomeVisitStore.instance.visits.any(
                    ...
                    (
                      'Upcoming Home Visit',
                      'A confirmed Home Visit is scheduled.',
                    ),
                  if (QueueStore.instance.active.any(
                    ...
                    (
                      'Queue update',
                      'A patient is ready to be called or consulted.',
                    ),
                  if (DoctorMedicalRecordStore.instance.records.any(
                    ...
                    (
                      'Follow-up reminder',
                      'A finalized record recommends follow-up.',
                    ),
                  if (ContactClinicStore.instance.messages.any(
                    ...
                    (
                      'Pet owner message',
                      'A new clinic message needs a response.',
                    ),
                ];

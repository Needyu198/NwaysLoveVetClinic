  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            const _DoctorPageHeader(title: 'Emergency Cases'),
            Expanded(
                ...
                builder: (context, _) {
                  ...
                  if (cases.isEmpty) {
                    return const _EmptyDoctorState(
                      ...
                      message:
                          'New accepted emergency requests will appear here.',
                    );
                  }
                    ...
                    itemBuilder: (context, index) => GestureDetector(
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute<void>(
                          builder: (_) => DoctorEmergencyCaseDetailsPage(
                            request: cases[index],
                          ),
                        ),
                      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            const _DoctorPageHeader(title: 'Emergency Case'),
            Expanded(
              child: AnimatedBuilder(
                animation: EmergencyRequestStore.instance,
                  ...
                  children: [
                    _DoctorDetailsCard(
                      rows: [
                        ...
                        (
                          'Breed and age',
                          '${request.pet.breed} • ${request.pet.age}',
                        ),
